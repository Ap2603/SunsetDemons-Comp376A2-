...
public class EnemySpawner : MonoBehaviour
{
   ...
   public void SpawnEnemies()
    ...
    public void SpawnWitch()
    {
        if (spawnenemies)
        {
            Vector3 witchpos = new Vector3(-15, 8, -15);
    ...
    public void SpawnBoss()
    {
        ...
        if (spawnboss)
        {
            ...
            if (bossdelay <= 0)
            {
                ...
                GameManager.GetComponent<GameController>().Heart1.enabled = true;
                GameManager.GetComponent<GameController>().Heart2.enabled = true;
                GameManager.GetComponent<GameController>().Heart3.enabled = true;
